  ...
  class Record < APIResource
    ...
    class << self
      ...
      def list(params = {}, object:, **opts)
        ...
        request = build_request(:POST, "#{resource_path}/#{object}/records/query", query_params, opts)
      ...
      def create(values:, object:, **opts)
        ...
        request = build_request(:POST, "#{resource_path}/#{object}/records", params, opts)
        response = execute_request(request)
      ...
      def retrieve(record_id:, object:, **opts)
        ...
        request = build_request(:GET, "#{resource_path}/#{object}/records/#{record_id}", {}, opts)
        response = execute_request(request)
      ...
      def create_batch(records:, object:, **opts)
        ...
        request = build_request(:POST, "#{resource_path}/batch", params, opts)
        response = execute_request(request)
    ...
    def save(**opts)
      ...
      request = self.class.send(:build_request, :PATCH, resource_path, params, opts)
