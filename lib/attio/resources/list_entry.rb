...
module Attio
  class ListEntry < Resources::Base
    ...
    attr_reader :list_id, :record_id, :added_by_actor, :record
    ...
    def record(opts = {})
      return @record if @record && @record.is_a?(Record)
    ...
    class << self
      ...
      alias remove_batch delete_batch
